...
// 重置密码按钮
const forgetButtonElement = document.querySelector(".forget-button");
forgetButtonElement.addEventListener('click', (e) => {
    e.preventDefault();
    ...
    forget(username, password, phone, code);
});

// 重置密码函数
function forget(username, password, phone, code) {
    if (username == "") {
        alert("请输入用户名");
    }
    else if (password == "") {
